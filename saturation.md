- saturation
  ...
  - 词义
    - n. 饱和；饱和度
    - `the degree to which something has been mixed into something else`
  - 记忆
    - sat(充足) + ur + ation → 充足 → 饱和(状态)
  - 同根词
    - adj.
      - `saturate` 浸透的，饱和的；深颜色的
      - `saturated` 饱和的；渗透的；深颜色的
    - v.
      - `saturated` 使渗透，使饱和（saturate的过去式）
    - vt.
      - `saturate` 浸透，使湿透；使饱和，使充满
  - 近义词
