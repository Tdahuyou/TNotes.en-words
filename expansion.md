- expansion
  ...
  - 同根词
    - adj.
      ...
      - `expansile` 可扩张的；扩大的；膨胀性的
    - adv.
      - `expansively` 辽阔地；可扩张地
    - n.
      - `expanse` 宽阔；广阔的区域；苍天；膨胀扩张
      - `expansionist` 领土扩张论者；扩张主义者
      - `expansiveness` 豪爽；广阔；可膨胀性
      - `expansionism` 扩张主义；扩张政策；膨胀主义
      - `expansivity` 扩大性；膨胀系数；可膨胀性
    - vi.
      - `expand` 发展；张开，展开
    - vt.
      - `expand` 扩张；使膨胀；详述
      - `expanded` 扩大（expand的过去式）
  - 近义词
    - n. 膨胀；阐述；扩张物
      - `inflation`
      - `exposition`
