- hypertension
  ...
  - 同根词
    - adj.
      ...
      - `hypertrophied` 过度增大的
    - n.
      - `hypertrophy` [病理] 肥大；过度增大
      - `hypertensive` 高血压患者
      - `hyperpigmentation` 着色过度；[病理] 色素沉着过度
      - `hyperpnea` 呼吸过强，[内科] 呼吸过度；喘息
      - `hypersomnia` 嗜睡，[医] 睡眠过度
      - `hypertensin` [生化] 血管紧张肽
      - `hypertonicity` 高张性；过度紧张；高渗性
    - v.
      - `hypertrophied` （使）过分生长（hypertrophy的过去分词）
  - 近义词
    - n. [内科]高血压；过度紧张
      - `high blood pressure`
      - `overtension`
