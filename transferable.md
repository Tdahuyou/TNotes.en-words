- transferable
  ...
  - 同根词
    - [生化].
      - `transferase` [生化] 转移酶；转换酶
    - adj.
      - `transferrable` 可转移的；可传递的；可转换的
    - n.
      - `transfer` 转让；转移；传递；过户
      - `transference` 转移；转让；调任
      - `transferee` 受让人；承让人；被调任者
      - `transferability` 可转移性；可转让性
      - `transferor` [专利] 转让人，让与人
      - `transferer` 转让者（等于transferrer）；换纬捶
      - `transferrer` 迁移者，转运者；调任者
    - vi.
      - `transfer` 转让；转移；转学；换车
    - vt.
      - `transfer` 转让；使转移；传递；调任
  - 近义词
    - adj. [数]可转让的；可转移的
      - `alienable`
      - `shiftable`
