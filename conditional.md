- conditional
  ...
  - 同根词
    - adj.
      - `conditioned` 有条件的，受制约的；习惯于…的
    - adv.
      - `conditionally` 附有条件地
    - n.
      - `condition` 条件；情况；环境；身分
      - `conditioning` 调节；条件作用；整修
      - `conditionality` 制约性；受限制性
    - v.
      - `conditioning` 以…为条件（condition的ing形式）
      - `conditioned` 使适应（condition的过去分词）；以…为条件
    - vt.
      - `condition` 使适应；使健康；决定；以…为条件
  - 近义词
    - adj. [数]有条件的；假定的
      - `supposed`
      - `assumed`
