- takings
  ...
  - 词义
    - n. [会计]收入；[金融]进款
    - `You can use takings to refer to the amount of money that a business such as a shop or a movie theatre gets from selling its goods or tickets during a particular period`
  - 近义词
    - n. [会计]收入；[金融]进款
      - `income`
      - `proceeds`
