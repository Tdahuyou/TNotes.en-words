- homogeneous
  ...
  - 同根词
    - adj.
      - `homogenized` 成为均匀分布的微粒的
    - adv.
      - `homogeneously` 同样地
    - n.
      - `homogeneity` 同质；同种；同次性（等于homogeneousness）
      - `homoeopathy` 顺势疗法；同种疗法
      - `homogeneousness` 均质性
      - `homograft` [生物][免疫] 同种移植物
    - v.
      - `homogenized` 使均匀；使类同；使（牛奶、奶油等中的油脂粒）分布均匀；变均匀（homogenize的过去式）
    - vi.
      - `homogenize` 变均匀
    - vt.
      - `homogenize` 使均匀；使类同
      - `homogenise` （英）使均匀（等于homogenize）
  - 近义词
