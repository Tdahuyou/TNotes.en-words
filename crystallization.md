- crystallization
  ...
  - 例句
    ...
    - `The finned crystallizers were compared with the horizontal crystallizers in efficiency and power consumption of crystallization process.`
      - 通过分析开车数据，对翅片式结晶器与卧式结晶器的结晶效率、结晶电耗进行比较。
