- concept
  ...
  - 同根词
    - adj.
      - `conceptual` 概念上的
      - `conceptional` 想象的；概念上的
      - `conceptive` 概念上的；有想像力的
    - adv.
      - `conceptually` 概念地
    - n.
      - `conception` 怀孕；概念；设想；开始
      - `conceptualization` 概念化；化为概念
      - `conceptualism` 概念论
    - vi.
      - `conceptualize` 概念化
      - `conceptualise` 概念化（等于conceptualize）
    - vt.
      - `conceptualize` 使概念化
      - `conceptualise` 使…概念化（等于conceptualize）
  - 近义词
    - n. 观念，概念
      - `idea`
      - `sense`
