- coordinator
  ...
  - 记忆
    - 来自coordinate(v. 调整， 协调)
  - 同根词
    - adj.
      - `coordinate` 并列的；同等的
      - `coordinated` 协调的
      - `coordinating` 协调的
      - `coordinative` 同等的；使…协调的；配位价的
    - n.
      - `coordinate` 坐标；同等的人或物
      - `coordination` 协调，调和；对等，同等
    - v.
      - `coordinating` 协调（coordinate的ing形式）；整合
    - vi.
      - `coordinate` 协调
    - vt.
      - `coordinate` 调整；整合
      - `coordinated` 调整；使调和（coordinate的过去分词）；调节；整理
  - 近义词
    - n. [经管][自]协调者；协调器；同等的人或物
      - `telegon`
  - 短语
  ...
  - 例句
    ...
    - `RM Inventory management: Cooperate with supply coordinator for the warehouse management.`
      - 原料仓库管理：配合供应协调员做原料仓库管理。
